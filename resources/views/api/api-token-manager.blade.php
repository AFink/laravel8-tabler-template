    ...
    @endif
        ...
        <x-jet-dialog-modal wire:model="displayingToken">
            ...
            <x-slot name="content">
                ...
                <div class="form-group">
                    <x-jet-input x-ref="plaintextToken" type="text" readonly :value="$plainTextToken" autofocus
                ...
                <div class="mt-2 row">
                    @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                        <div class="col-6">
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    <x-jet-checkbox wire:model.defer="updateApiTokenForm.permissions"
                                        id="{{ 'update-' . $permission }}" :value="$permission" />
